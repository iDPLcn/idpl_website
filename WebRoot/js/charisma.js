    ...
    History.Adapter.bind(window, 'statechange', function () { // Note: We are using statechange instead of popstate
        ...
        $.ajax({
            ...
            success: function (msg) {
                $('#page-content').html($(msg).find('#page-content').html());
                $('#loading').remove();
                $('#page-content').fadeIn();
...
function docReady() {
    ...
    function showResult(){//鍒犻櫎鏄剧ず鐨勪笂浼犳垚鍔熺粨鏋�        
    	$("#result").html("");
    }
    function uploadFile(){//涓婁紶鏂囦欢
        jQuery('#uploadify').uploadifyUpload();
    }
    function clearFile(){//娓呯┖鎵�湁涓婁紶闃熷垪
    ...
    if ($('.tour').length && typeof(tour) == 'undefined') {
        var tour = new Tour();
        tour.addStep({
            element: "#page-content", /* html element next to which the step popover should be shown */
            placement: "top",
